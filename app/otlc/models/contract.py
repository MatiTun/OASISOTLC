...
class AccountStatusHeader(db.Model, BaseModel):
    ...
    EE_TIPO             = db.Column(db.String(30), nullable=False, info={'name':'Tipo'})
    EE_PRECIO           = db.Column(db.Numeric(12,2), nullable=False, info={'name':'Precio_Contrato'})
    EE_PAGO_MENSUAL     = db.Column(db.Numeric(12,2), nullable=False, info={'name':'Pago_Mensual'})
    EE_MONEDA           = db.Column(db.String(3), nullable=False, info={'name':'Moneda'})
    EE_TC               = db.Column(db.Numeric(9,4), info={'name':'TC'})
    EE_TASA_INTERES     = db.Column(db.Numeric(7,2), nullable=True, info={'name':'Tasa_Interes'})
    EE_PM_INICIAL       = db.Column(db.Numeric(3,0), nullable=False, info={'name':'PM_Inicial'})
    EE_PM_PAGADO        = db.Column(db.Numeric(3,0), nullable=False, info={'name':'PM_Pagado'})
    EE_PM_SALDO         = db.Column(db.Numeric(3,0), nullable=False, info={'name':'PM_Saldo'})
    EE_CC_INICIAL       = db.Column(db.Numeric(3,0), nullable=False, info={'name':'CC_Inicial'})
    EE_CC_PAGADO        = db.Column(db.Numeric(3,0), nullable=False, info={'name':'CC_Pagado'})
    EE_CC_SALDO         = db.Column(db.Numeric(3,0), nullable=False, info={'name':'CC_Saldo'})
    EE_EG_POR           = db.Column(db.Numeric(12,2), nullable=False, info={'name':'EG_Por'})
    EE_EG_IMP           = db.Column(db.Numeric(12,2), nullable=False, info={'name':'EG_Inicial'})
    EE_EG_PAGADO        = db.Column(db.Numeric(12,2), nullable=False, info={'name':'EG_Pagado'})
    EE_EG_SALDO         = db.Column(db.Numeric(12,2), nullable=False, info={'name':'EG_Saldo'})
    EE_FN_INICIAL       = db.Column(db.Numeric(12,2), nullable=False, info={'name':'FN_Inicial'})
    EE_FN_PAGADO        = db.Column(db.Numeric(12,2), nullable=False, info={'name':'FN_Pagado'})
    EE_FN_SALDO         = db.Column(db.Numeric(12,2), nullable=False, info={'name':'FN_Saldo'})
    EE_IN_INICIAL       = db.Column(db.Numeric(12,2), nullable=False, info={'name':'IN_Inicial'})
    EE_IN_PAGADO        = db.Column(db.Numeric(12,2), nullable=False, info={'name':'IN_Pagado'})
    EE_IN_SALDO         = db.Column(db.Numeric(12,2), nullable=False, info={'name':'IN_Saldo'})
    EE_MT_INICIAL       = db.Column(db.Numeric(12,2), nullable=False, info={'name':'Total_Inicial'})
    EE_MT_PAGADO        = db.Column(db.Numeric(12,2), nullable=False, info={'name':'Total_Pagado'})
    EE_MT_SALDO         = db.Column(db.Numeric(12,2), nullable=False, info={'name':'Total_Saldo'})
...
class AccountStatusBody(db.Model, BaseModel):
    ...
    ED_FECHA_PAGO    = db.Column(db.DateTime(), nullable=False, info={'name':'Fecha_Pago'})
    ED_TOTAL_PAGADO  = db.Column(db.Numeric(12,2), nullable=False, info={'name':'Total_Pagado'})
    ED_TOTAL_SALDO   = db.Column(db.Numeric(12,2), nullable=False, info={'name':'Saldo_Mes'})
    ED_FORMA_PAGO    = db.Column(db.String(12), nullable=False, info={'name':'Forma_Pago'})
